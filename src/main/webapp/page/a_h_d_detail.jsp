      ...
      <div class="right_content">
       <div class="order order_list" id="order_list" >
    	  <div class="right_menu">
			  ...
			  <form action="doctor_save" method="post">
				  <table>
					  <tr>
						  <td>did：</td>
						  <td>
							  <input disabled value="${doctor.did}"/>&nbsp;*
							  <input name="did" type="hidden" value="${doctor.did}"/>
						  </td>
					  </tr>
					  <tr>
						  <td>name：</td>
						  <td><input name="name" value="${doctor.name}"/>&nbsp;*</td>
					  </tr>
					  <tr>
						  <td>gender：</td>
						  <td><input name="type" value="${doctor.gender}"/>&nbsp;*</td>
					  </tr>
					  <tr>
						  <td>title：</td>
						  <td><input name="title" value="${doctor.title}"/>&nbsp;*</td>
					  </tr>
					  <tr>
						  <td>path：</td>
						  <td><input name="path" value="${doctor.path}"/></td>
					  </tr>
					  <tr>
						  <td>goodat：</td>
						  <td><textarea  name="goodat" >${doctor.goodat}</textarea></td>
					  </tr>
					  <tr>
						  <td>intro：</td>
						  <td><textarea  name="intro" >${doctor.intro}</textarea></td>
					  </tr>
					  <tr>
						  <td>oid：</td>
						  <td><input name="oid" value="${doctor.oid}"/>&nbsp;*</td>
					  </tr>
