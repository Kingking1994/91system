      ...
      <div class="right_content">
       <div class="order order_list" id="order_list" >
    	  <div class="right_menu">
			  ...
			  <form action="<%=path%>/hAdmin/schedule_save" method="post">
				  <table>
					  ...
					  <tr>
						  <td>num：</td>
						  <td><input name="num" value=""/>&nbsp;*</td>
					  </tr>
					  <tr>
						  <td>ordernum：</td>
						  <td><input name="ordernum" value=""/>&nbsp;*</td>
					  </tr>
					  <tr>
						  <td>fee：</td>
						  <td><input name="fee" value=""/>&nbsp;*</td>
					  </tr>
					  <tr>
						  <td>did：</td>
						  <td><input name="did" value=""/>&nbsp;*</td>
					  </tr>
