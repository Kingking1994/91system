...
<!--左侧边栏-->
    ...
    <div class="right_main">
        <div class="right_title title">
    		<span>医院管理</span>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<a style="font-size: 20px" href="<%=path%>/page/a_h_d_add.jsp"><button>添加</button></a>
    	</div>
    		...
    		<div class="right_menu_title">
			  ...
			  <div class="right_item">
				  <div class="item_detail">
					  <ul class="clearfix">
						  <li><a href="<%=path%>/hAdmin/doctor_update?did=${doctor.did}">${doctor.did}</a></li>
						  <li>${doctor.name}</li>
						  <li>${doctor.title}</li>
						  <li><a href="<%=path%>/hAdmin/office_update?oid=${office.oid}">${doctor.oid}</a></li>
						  <li>
							<span>
								<a href="<%=path%>/hAdmin/doctor_update?did=${doctor.did}">修改</a>
							</span>
							<span>
								<a href="<%=path%>/hAdmin/doctor_delete?did=${doctor.did}">删除</a>
							</span>
						  </li>
					  </ul>
				  </div>
